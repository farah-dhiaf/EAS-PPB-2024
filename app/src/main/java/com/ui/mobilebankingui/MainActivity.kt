            ...
            MobileBankingUITheme {
                ...
                Surface(
                    ...
                    NavHost(navController = navController, startDestination = "login") {
                        ...
                        composable("settlement") { SettlementScreen(navController)}
                        composable("pin") { PinScreen(navController)}
                        composable("pinS") { PinSettlementScreen(navController)}
                        composable("verifikasi") { VerificationScreen(navController)}
                        composable("verifikasiS") { VerifSettlementScreen(navController)}
                    }
                }
            }
        }
