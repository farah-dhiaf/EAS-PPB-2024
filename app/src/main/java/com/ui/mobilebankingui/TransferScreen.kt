...
fun TransferScreen(navController: NavHostController) {
    ...
    Column(
        ...
        Image(painter = painterResource(id = R.drawable.logomitra), contentDescription = "Logo image",
            modifier = Modifier.size(200.dp))

        Text(text = "Payment", fontSize = 28.sp, fontWeight = FontWeight.Bold)
        ...
        OutlinedTextField(value = rekening, onValueChange = {
            ...
            Text(text = "Masukan kode pembayaran")
        })
